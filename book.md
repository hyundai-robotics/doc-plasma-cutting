...
# 2. 플라즈마 절단 응용
[__SOURCE](2-application/1-communication.md)
# 2.1 통신
...
![그림2.1 시작 조건](../../_assets/start_cnd.png)
...
![그림2.2 절단 차트](../../_assets/cut_chart.png)
...
![그림2.3 모션 조건](../../_assets/motion_cnd.png)
...
![그림2.4 종료 조건](../../_assets/end_cnd.png)
...
## 2.4.2 plasma on/off 명령어
   ...
   부재의 내부 면에서 절단을 시작하므로 천공(piercing) 작업이 먼저 선행되어야 합니다. 플라즈마 아크를 안정화 하기 위한 추가적인 높이 이동 후에 절단을 시작 할 수 있습니다.
     ...
     ![그림2.5 천공 타입의 로봇 이동 절차](../../_assets/pierce_start.png)
   ...
   - 에지(edge) 방식  
     ...
     ![그림2.6 에지 타입의 로봇 이동 절차](../../_assets/edge_start.png)
