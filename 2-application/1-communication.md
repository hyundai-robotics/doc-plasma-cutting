...
### (5) 주의 사항
- 전자기 간섭(EMI) 방지: 플라즈마 아크 발생 시 고주파 노이즈가 발생하므로, 반드시 이중 차폐(SF/UTP) 처리된 산업용 이더넷 케이블과 금속 쉘 커넥터를 사용하여 접지 상태를 확인하십시오.
- 통신 주기(Cycle Time): 시스템 안정성을 위해 로봇 제어기의 통신 주기를 응용프로그램의 제어주기와(5msec) 같도록 설정하십시오.